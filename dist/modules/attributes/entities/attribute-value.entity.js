...
let AttributeValue = class AttributeValue extends base_entity_1.BaseEntity {
};
...
__decorate([
    ...
    __metadata("design:type", String)
], AttributeValue.prototype, "colorCode", void 0);
__decorate([
    (0, typeorm_1.ManyToOne)(() => attribute_entity_1.Attribute, attribute => attribute.values, { onDelete: 'CASCADE' }),
