...
exports.AttributeValueSeeder = void 0;
...
class AttributeValueSeeder extends base_seeder_1.BaseSeeder {
    constructor(dataSource) {
        super(dataSource);
    }
    async run() {
        const attributeRepository = this.dataSource.getRepository(attribute_entity_1.Attribute);
        const attributeValueRepository = this.dataSource.getRepository(attribute_value_entity_1.AttributeValue);
        ...
        const getAttr = (name) => attributeMap.get(name);
        const values = [
            // Fabric
        ...
        await this.saveMany(valueEntities, attribute_value_entity_1.AttributeValue);
        console.log('Attribute values seeded successfully');
    }
}
exports.AttributeValueSeeder = AttributeValueSeeder;
