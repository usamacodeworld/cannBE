...
export class UpdatedSchemasa1750147591093 implements MigrationInterface {
  name = "UpdatedSchemasa1750147591093";
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`CREATE TABLE "users" (
        ...
        COMMENT ON COLUMN "users"."type" IS 'admin, seller, buyer. Roles outside of the scope has no effect';
    ...
    await queryRunner.query(`CREATE TABLE "role_permissions" (
            ...
            CONSTRAINT "PK_ac47b71a830e90c75f41040ba1a" PRIMARY KEY ("roleId", "permissionName")
        )`);
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_b4f3a5b54478bd9a66cb6ad8e4" ON "role_permissions" ("permissionName")`
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "role_permissions" ADD CONSTRAINT "FK_b4f3a5b54478bd9a66cb6ad8e4a" FOREIGN KEY ("permissionName") REFERENCES "permissions"("name") ON DELETE NO ACTION ON UPDATE NO ACTION`
    );
  }
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_b4f3a5b54478bd9a66cb6ad8e4"`
    );
    await queryRunner.query(
